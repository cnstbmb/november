...
INVENTORY_PATH="${INVENTORY_PATH:-infra/ansible/inventories/prod/hosts.yml}"
PLAYBOOK_PATH="${PLAYBOOK_PATH:-infra/ansible/playbooks/site.yml}"
...
FILES_TO_CHECK="$(find infra/ansible/inventories/prod -type f \( -name "*.yml" -o -name "*.yaml" \) | sort)"
