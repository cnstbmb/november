...
- **Child ticket**: an issue linked as a GitHub sub-issue. If sub-issues are unavailable, add it to the map's task list and put `Part of #<map>` at the top of its body.
...
- **Resolve**: comment with the result, close the child, and append its context pointer to the map.
